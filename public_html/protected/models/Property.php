...
class Property extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, picture, title, description, lat, lng, floor, room, garage, restroom, area, project_provider, swiming_pool, residentailtype_id, Project_id, customers_id', 'safe', 'on'=>'search'),
		);
	}
