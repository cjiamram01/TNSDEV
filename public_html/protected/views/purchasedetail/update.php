...
$this->menu=array(
	...
	array('label'=>'View Purchasedetail', 'url'=>array('view', 'id'=>$model->id)),
...
<h2 class="headline first-child text-color"><span class="border-color">Update Purchasedetail <?php echo $model->id; ?></span></h2>
  ...
  <div class="modal-dialog" style="width:1010px" >
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Purchasedetail</h4>
      </div>
