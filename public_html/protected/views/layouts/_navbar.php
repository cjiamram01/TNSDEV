...
<?php   if($page === 'site/index'): echo '<li class="active">'; else: echo '<li>'; endif;
echo CHtml::link('<i class="fa fa-home"></i> '.Yii::t('app','Home'),array('site/index'),array('class'=>'bg-hover-color')).'</li>'; ?>

<?php   if($page === 'translate/index'): echo '<li class="active">'; else: echo '<li>'; endif;
echo CHtml::link('<i class="fa fa-pencil"></i> '.Yii::t('app','Translate'),array('translate/index'),array('class'=>'bg-hover-color')).'</li>'; ?>

<?php if(Yii::app()->user->isAdmin()): ?>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle bg-hover-color" data-toggle="dropdown"><i class="fa fa-bars"></i> <?php echo Yii::t('app','Dashboard'); ?><b class="caret"></b></a>
              <ul class="dropdown-menu">
                <?php   if($page === 'users/index'): echo '<li class="active">'; else: echo '<li>'; endif;
