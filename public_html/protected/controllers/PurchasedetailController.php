...
class PurchasedetailController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Purchasedetail'];
			if($model->save())
	...
	public function actionUpdate($id)
	{
		...
		$lists=new Purchasedetail('search');
		$lists->unsetAttributes();  // clear any default values
		if(isset($_GET['Purchasedetail']))
			$lists->attributes=$_GET['Purchasedetail'];
	...
	{
		$model=new Purchasedetail('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Purchasedetail']))
			$model->attributes=$_GET['Purchasedetail'];
